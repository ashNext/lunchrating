...
class MenuControllerTest extends AbstractControllerTest {
    ...
    void createWithLocation() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post(REST_URL_R100000)
                .contentType(MediaType.APPLICATION_JSON)
                .content(getMapper().writeValueAsString("{\"date\": \"2020-08-21\"}")));
    }

    @Test
    void update() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.put(REST_URL_R100000)
                .contentType(MediaType.APPLICATION_JSON)
                .content(getMapper().writeValueAsString("{\"date\": \"2020-08-01\"}")));
    }
}